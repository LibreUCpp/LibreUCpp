...
struct __attribute__((aligned(4), packed)) EXTI_T
{
    ...
    volatile union IMR_T // IMR: Interrupt mask register (EXTI_IMR) 
    {
        ...
        struct __attribute__((packed)) IMR_BIT_T
        {
            ...
            unsigned MR23 : 1; // bit 23 Interrupt Mask on line 23
            unsigned MR24 : 1; // bit 24 Interrupt Mask on line 24
            unsigned MR25 : 1; // bit 25 Interrupt Mask on line 25
            unsigned MR26 : 1; // bit 26 Interrupt Mask on line 26
            unsigned MR27 : 1; // bit 27 Interrupt Mask on line 27
        ...
        static constexpr unsigned MR23_POS = 23;
        static constexpr unsigned MR23_MASK = 0x00800000;
        static constexpr unsigned MR23(unsigned value) { return (value << 23); }
        static constexpr unsigned MR24_POS = 24;
        static constexpr unsigned MR24_MASK = 0x01000000;
        static constexpr unsigned MR24(unsigned value) { return (value << 24); }
        static constexpr unsigned MR25_POS = 25;
        static constexpr unsigned MR25_MASK = 0x02000000;
        static constexpr unsigned MR25(unsigned value) { return (value << 25); }
        static constexpr unsigned MR26_POS = 26;
        static constexpr unsigned MR26_MASK = 0x04000000;
        static constexpr unsigned MR26(unsigned value) { return (value << 26); }
        static constexpr unsigned MR27_POS = 27;
        static constexpr unsigned MR27_MASK = 0x08000000;
        static constexpr unsigned MR27(unsigned value) { return (value << 27); }
    } IMR;
    ...
    volatile union EMR_T // EMR: Event mask register (EXTI_EMR) 
    {
        ...
        struct __attribute__((packed)) EMR_BIT_T
        {
            ...
            unsigned MR23 : 1; // bit 23 Event Mask on line 23
            unsigned MR24 : 1; // bit 24 Event Mask on line 24
            unsigned MR25 : 1; // bit 25 Event Mask on line 25
            unsigned MR26 : 1; // bit 26 Event Mask on line 26
            unsigned MR27 : 1; // bit 27 Event Mask on line 27
            unsigned      : 4; // bits 28..31 unused    
        } bit;
