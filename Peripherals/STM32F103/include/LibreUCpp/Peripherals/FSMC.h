...
struct __attribute__((aligned(4), packed)) FSMC_T
{
    ...
    volatile union PATT2_T // PATT2: Attribute memory space timing register 2 
    {
        ...
        {
            unsigned ATTSETx  : 8; // bits 0..7 Attribute memory x setup time
            unsigned ATTWAITx : 8; // bits 8..15 Attribute memory x wait time
            unsigned ATTHOLDx : 8; // bits 16..23 Attribute memory x hold time
            unsigned ATTHIZx  : 8; // bits 24..31 Attribute memory x databus HiZ time    
        } bit;
    ...
    volatile union ECCR2_T // ECCR2: ECC result register 2 
    {
        ...
        {
            unsigned ECCx : 32; // bits 0..31 ECC result    
        } bit;
