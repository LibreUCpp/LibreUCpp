...
struct __attribute__((aligned(4), packed)) UART_T
{
    ...
    volatile union SR_T // SR: UART4_SR 
    {
        uint32_t reg;
    ...
    volatile union DR_T // DR: UART4_DR 
    {
        uint32_t reg;
    ...
    volatile union BRR_T // BRR: UART4_BRR 
    {
        uint32_t reg;
    ...
    volatile union CR1_T // CR1: UART4_CR1 
    {
        uint32_t reg;
    ...
    volatile union CR2_T // CR2: UART4_CR2 
    {
        uint32_t reg;
    ...
    volatile union CR3_T // CR3: UART4_CR3 
    {
        uint32_t reg;
...
static_assert(sizeof(UART_T) == UART_T::PADDED_INSTANCE_SIZE, "invalid peripheral register struct");
