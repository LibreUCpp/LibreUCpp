...
struct __attribute__((aligned(4), packed)) ADC2_T
{
    static constexpr size_t INSTANCE_SIZE = 80;
    static constexpr size_t PADDED_INSTANCE_SIZE = 80;
    static constexpr intptr_t BASE_ADDRESS_ADC2 = 0x40012800;
    static constexpr intptr_t BASE_ADDRESS_ADC3 = 0x40013c00;
    ...
    volatile union SMPR1_T // SMPR1: sample time register 1 
    {
        ...
        {
            unsigned SMP10 : 3; // bits 0..2 Channel 10 sample time selection
            unsigned SMP11 : 3; // bits 3..5 Channel 11 sample time selection
            unsigned SMP12 : 3; // bits 6..8 Channel 12 sample time selection
            unsigned SMP13 : 3; // bits 9..11 Channel 13 sample time selection
            unsigned SMP14 : 3; // bits 12..14 Channel 14 sample time selection
            unsigned SMP15 : 3; // bits 15..17 Channel 15 sample time selection
            unsigned SMP16 : 3; // bits 18..20 Channel 16 sample time selection
            unsigned SMP17 : 3; // bits 21..23 Channel 17 sample time selection
            unsigned       : 8; // bits 24..31 unused    
        } bit;
    ...
    volatile union SMPR2_T // SMPR2: sample time register 2 
    {
        ...
        {
            unsigned SMP0 : 3; // bits 0..2 Channel 0 sample time selection
            unsigned SMP1 : 3; // bits 3..5 Channel 1 sample time selection
            unsigned SMP2 : 3; // bits 6..8 Channel 2 sample time selection
            unsigned SMP3 : 3; // bits 9..11 Channel 3 sample time selection
            unsigned SMP4 : 3; // bits 12..14 Channel 4 sample time selection
            unsigned SMP5 : 3; // bits 15..17 Channel 5 sample time selection
            unsigned SMP6 : 3; // bits 18..20 Channel 6 sample time selection
            unsigned SMP7 : 3; // bits 21..23 Channel 7 sample time selection
            unsigned SMP8 : 3; // bits 24..26 Channel 8 sample time selection
            unsigned SMP9 : 3; // bits 27..29 Channel 9 sample time selection
...
static_assert(sizeof(ADC2_T) == ADC2_T::PADDED_INSTANCE_SIZE, "invalid peripheral register struct");
