...
struct __attribute__((aligned(4), packed)) TIM6_T
{
    ...
    static constexpr intptr_t BASE_ADDRESS_TIM6 = 0x40001000;
    static constexpr intptr_t BASE_ADDRESS_TIM7 = 0x40001400;
...
static_assert(sizeof(TIM6_T) == TIM6_T::PADDED_INSTANCE_SIZE, "invalid peripheral register struct");
