...
struct __attribute__((aligned(4), packed)) DMAC_T
{
    ...
    static constexpr intptr_t BASE_ADDRESS = 0x41004800;
    ...
    volatile union PRICTRL_T // PRICTRL: Priority Control 0 
    {
        ...
        static constexpr unsigned LVLPRI1_MASK = 0x00000700;
        ...
        static constexpr unsigned LVLPRI2_MASK = 0x00070000;
        ...
        static constexpr unsigned LVLPRI3_MASK = 0x07000000;
    ...
    volatile union INTPEND_T // INTPEND: Interrupt Pending 
    {
        ...
        {
            unsigned ID    : 3; // bits 0..2 Channel ID
            unsigned       : 5; // bits 3..7 unused
        ...
        static constexpr unsigned ID_MASK = 0x00000007;
    ...
    volatile union CHCTRLB_T // CHCTRLB: Channel Control B 
    {
        ...
        struct __attribute__((packed)) CHCTRLB_BIT_T
        {
            ...
            unsigned TRIGSRC : 5; // bits 8..12 Trigger Source
            unsigned         : 9; // bits 13..21 unused
        ...
        static constexpr unsigned TRIGSRC_MASK = 0x00001f00;
...
static_assert(sizeof(DMAC_T) == DMAC_T::PADDED_INSTANCE_SIZE, "invalid peripheral register struct");
