...
struct __attribute__((aligned(4), packed)) AFIO_T
{
    ...
    volatile union MAPR_T // MAPR: AF remap and debug I/O configuration register (AFIO_MAPR) 
    {
        ...
        struct __attribute__((packed)) MAPR_BIT_T
        {
            ...
            unsigned CAN1_REMAP      : 2; // bits 13..14 CAN1 remapping
            ...
            unsigned                 : 4; // bits 17..20 unused
            unsigned ETH_REMAP       : 1; // bit 21 Ethernet MAC I/O remapping
            unsigned CAN2_REMAP      : 1; // bit 22 CAN2 I/O remapping
            unsigned MII_RMII_SEL    : 1; // bit 23 MII or RMII selection
            unsigned SWJ_CFG         : 3; // bits 24..26 Serial wire JTAG configuration
            unsigned                 : 1; // bit 27 unused
            unsigned SPI3_REMAP      : 1; // bit 28 SPI3/I2S3 remapping
            unsigned TIM2ITR1_IREMAP : 1; // bit 29 TIM2 internal trigger 1 remapping
            unsigned PTP_PPS_REMAP   : 1; // bit 30 Ethernet PTP PPS remapping
        ...
        static constexpr unsigned CAN1_REMAP_POS = 13;
        static constexpr unsigned CAN1_REMAP_MASK = 0x00006000;
        static constexpr unsigned CAN1_REMAP(unsigned value) { return (value << 13); }
        ...
        static constexpr unsigned ETH_REMAP_POS = 21;
        static constexpr unsigned ETH_REMAP_MASK = 0x00200000;
        static constexpr unsigned ETH_REMAP(unsigned value) { return (value << 21); }
        static constexpr unsigned CAN2_REMAP_POS = 22;
        static constexpr unsigned CAN2_REMAP_MASK = 0x00400000;
        static constexpr unsigned CAN2_REMAP(unsigned value) { return (value << 22); }
        ...
        static constexpr unsigned SPI3_REMAP_POS = 28;
        static constexpr unsigned SPI3_REMAP_MASK = 0x10000000;
        static constexpr unsigned SPI3_REMAP(unsigned value) { return (value << 28); }
        static constexpr unsigned TIM2ITR1_IREMAP_POS = 29;
        static constexpr unsigned TIM2ITR1_IREMAP_MASK = 0x20000000;
        static constexpr unsigned TIM2ITR1_IREMAP(unsigned value) { return (value << 29); }
        static constexpr unsigned PTP_PPS_REMAP_POS = 30;
        static constexpr unsigned PTP_PPS_REMAP_MASK = 0x40000000;
        static constexpr unsigned PTP_PPS_REMAP(unsigned value) { return (value << 30); }
    } MAPR;
