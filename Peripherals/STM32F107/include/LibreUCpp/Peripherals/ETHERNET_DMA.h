...
struct __attribute__((aligned(4), packed)) ETHERNET_DMA_T
{
    ...
    static constexpr size_t PADDED_INSTANCE_SIZE = 88;
    ...
    volatile union DMABMR_T // DMABMR: Ethernet DMA bus mode register 
    {
        ...
        {
            unsigned SR   : 1; // bit 0 Software reset
            unsigned DA   : 1; // bit 1 DMA Arbitration
            unsigned DSL  : 5; // bits 2..6 Descriptor skip length
            unsigned      : 1; // bit 7 unused
            unsigned PBL  : 6; // bits 8..13 Programmable burst length
            unsigned RTPR : 2; // bits 14..15 Rx Tx priority ratio
            unsigned FB   : 1; // bit 16 Fixed burst
            unsigned RDP  : 6; // bits 17..22 Rx DMA PBL
            unsigned USP  : 1; // bit 23 Use separate PBL
            unsigned FPM  : 1; // bit 24 4xPBL mode
            unsigned AAB  : 1; // bit 25 Address-aligned beats
    ...
    volatile union DMATPDR_T // DMATPDR: Ethernet DMA transmit poll demand register 
    {
        ...
        {
            unsigned TPD : 32; // bits 0..31 Transmit poll demand    
        } bit;
    ...
    volatile union DMARPDR_T // DMARPDR: EHERNET DMA receive poll demand register 
    {
        ...
        {
            unsigned RPD : 32; // bits 0..31 Receive poll demand    
        } bit;
    ...
    volatile union DMARDLAR_T // DMARDLAR: Ethernet DMA receive descriptor list address register 
    {
        ...
        {
            unsigned SRL : 32; // bits 0..31 Start of receive list    
        } bit;
    ...
    volatile union DMATDLAR_T // DMATDLAR: Ethernet DMA transmit descriptor list address register 
    {
        ...
        {
            unsigned STL : 32; // bits 0..31 Start of transmit list    
        } bit;
    ...
    volatile union DMASR_T // DMASR: Ethernet DMA status register 
    {
        ...
        {
            unsigned TS   : 1; // bit 0 Transmit status
            unsigned TPSS : 1; // bit 1 Transmit process stopped status
            unsigned TBUS : 1; // bit 2 Transmit buffer unavailable status
            unsigned TJTS : 1; // bit 3 Transmit jabber timeout status
            unsigned ROS  : 1; // bit 4 Receive overflow status
            unsigned TUS  : 1; // bit 5 Transmit underflow status
            unsigned RS   : 1; // bit 6 Receive status
            unsigned RBUS : 1; // bit 7 Receive buffer unavailable status
            unsigned RPSS : 1; // bit 8 Receive process stopped status
            unsigned PWTS : 1; // bit 9 Receive watchdog timeout status
            unsigned ETS  : 1; // bit 10 Early transmit status
            unsigned      : 2; // bits 11..12 unused
            unsigned FBES : 1; // bit 13 Fatal bus error status
            unsigned ERS  : 1; // bit 14 Early receive status
            unsigned AIS  : 1; // bit 15 Abnormal interrupt summary
            unsigned NIS  : 1; // bit 16 Normal interrupt summary
            unsigned RPS  : 3; // bits 17..19 Receive process state
            unsigned TPS  : 3; // bits 20..22 Transmit process state
            unsigned EBS  : 3; // bits 23..25 Error bits status
            unsigned      : 1; // bit 26 unused
            unsigned MMCS : 1; // bit 27 MMC status
            unsigned PMTS : 1; // bit 28 PMT status
            unsigned TSTS : 1; // bit 29 Time stamp trigger status
    ...
    volatile union DMAIER_T // DMAIER: Ethernet DMA interrupt enable register 
    {
        ...
        {
            unsigned TIE   : 1; // bit 0 Transmit interrupt enable
            unsigned TPSIE : 1; // bit 1 Transmit process stopped interrupt enable
            unsigned TBUIE : 1; // bit 2 Transmit buffer unavailable interrupt enable
            unsigned TJTIE : 1; // bit 3 Transmit jabber timeout interrupt enable
            unsigned ROIE  : 1; // bit 4 Overflow interrupt enable
            unsigned TUIE  : 1; // bit 5 Underflow interrupt enable
            unsigned RIE   : 1; // bit 6 Receive interrupt enable
            unsigned RBUIE : 1; // bit 7 Receive buffer unavailable interrupt enable
            unsigned RPSIE : 1; // bit 8 Receive process stopped interrupt enable
            unsigned RWTIE : 1; // bit 9 receive watchdog timeout interrupt enable
            unsigned ETIE  : 1; // bit 10 Early transmit interrupt enable
            unsigned       : 2; // bits 11..12 unused
            unsigned FBEIE : 1; // bit 13 Fatal bus error interrupt enable
            unsigned ERIE  : 1; // bit 14 Early receive interrupt enable
            unsigned AISE  : 1; // bit 15 Abnormal interrupt summary enable
            unsigned NISE  : 1; // bit 16 Normal interrupt summary enable
    ...
    volatile union DMAMFBOCR_T // DMAMFBOCR: Ethernet DMA missed frame and buffer overflow counter register 
    {
        ...
        {
            unsigned MFC  : 16; // bits 0..15 Missed frames by the controller
            unsigned OMFC : 1; // bit 16 Overflow bit for missed frame counter
            unsigned MFA  : 11; // bits 17..27 Missed frames by the application
            unsigned OFOC : 1; // bit 28 Overflow bit for FIFO overflow counter
    ...
    volatile union DMACHTDR_T // DMACHTDR: Ethernet DMA current host transmit descriptor register 
    {
        ...
        {
            unsigned HTDAP : 32; // bits 0..31 Host transmit descriptor address pointer    
        } bit;
    ...
    volatile union DMACHRDR_T // DMACHRDR: Ethernet DMA current host receive descriptor register 
    {
        ...
        {
            unsigned HRDAP : 32; // bits 0..31 Host receive descriptor address pointer    
        } bit;
    ...
    volatile union DMACHTBAR_T // DMACHTBAR: Ethernet DMA current host transmit buffer address register 
    {
        ...
        {
            unsigned HTBAP : 32; // bits 0..31 Host transmit buffer address pointer    
        } bit;
    ...
    volatile union DMACHRBAR_T // DMACHRBAR: Ethernet DMA current host receive buffer address register 
    {
        ...
        {
            unsigned HRBAP : 32; // bits 0..31 Host receive buffer address pointer    
        } bit;
...
static_assert(sizeof(ETHERNET_DMA_T) == ETHERNET_DMA_T::PADDED_INSTANCE_SIZE, "invalid peripheral register struct");
