...
struct __attribute__((aligned(4), packed)) BKP_T
{
    ...
    static constexpr size_t PADDED_INSTANCE_SIZE = 188;
    ...
    volatile union CSR_T // CSR: BKP_CSR control/status register 
    {
        uint32_t reg;
...
static_assert(sizeof(BKP_T) == BKP_T::PADDED_INSTANCE_SIZE, "invalid peripheral register struct");
