...
struct __attribute__((aligned(4), packed)) ADC_T
{
    ...
    static constexpr intptr_t BASE_ADDRESS_ADC1 = 0x40012000;
    static constexpr intptr_t BASE_ADDRESS_ADC2 = 0x40012100;
    static constexpr intptr_t BASE_ADDRESS_ADC3 = 0x40012200;
    ...
    volatile union SR_T // SR: status register 
    {
        ...
        static constexpr unsigned OVR_POS = 5;
        static constexpr unsigned OVR_MASK = 0x00000020;
        static constexpr unsigned OVR(unsigned value) { return (value << 5); }
    } SR;
    ...
    volatile union CR1_T // CR1: control register 1 
    {
        ...
        struct __attribute__((packed)) CR1_BIT_T
        {
            ...
            unsigned RES     : 2; // bits 24..25 Resolution
            unsigned OVRIE   : 1; // bit 26 Overrun interrupt enable
        ...
        static constexpr unsigned RES_POS = 24;
        static constexpr unsigned RES_MASK = 0x03000000;
        static constexpr unsigned RES(unsigned value) { return (value << 24); }
        static constexpr unsigned OVRIE_POS = 26;
        static constexpr unsigned OVRIE_MASK = 0x04000000;
        static constexpr unsigned OVRIE(unsigned value) { return (value << 26); }
    } CR1;
    ...
    volatile union CR2_T // CR2: control register 2 
    {
        ...
        struct __attribute__((packed)) CR2_BIT_T
        {
            ...
            unsigned DMA      : 1; // bit 8 Direct memory access mode (for single ADC mode)
            unsigned DDS      : 1; // bit 9 DMA disable selection (for single ADC mode)
            unsigned EOCS     : 1; // bit 10 End of conversion selection
            unsigned ALIGN    : 1; // bit 11 Data alignment
            unsigned          : 4; // bits 12..15 unused
            unsigned JEXTSEL  : 4; // bits 16..19 External event select for injected group
            unsigned JEXTEN   : 2; // bits 20..21 External trigger enable for injected channels
            unsigned JSWSTART : 1; // bit 22 Start conversion of injected channels
            unsigned          : 1; // bit 23 unused
            unsigned EXTSEL   : 4; // bits 24..27 External event select for regular group
            unsigned EXTEN    : 2; // bits 28..29 External trigger enable for regular channels
            unsigned SWSTART  : 1; // bit 30 Start conversion of regular channels
        ...
        static constexpr unsigned DDS_POS = 9;
        static constexpr unsigned DDS_MASK = 0x00000200;
        static constexpr unsigned DDS(unsigned value) { return (value << 9); }
        static constexpr unsigned EOCS_POS = 10;
        static constexpr unsigned EOCS_MASK = 0x00000400;
        static constexpr unsigned EOCS(unsigned value) { return (value << 10); }
        ...
        static constexpr unsigned JEXTSEL_POS = 16;
        static constexpr unsigned JEXTSEL_MASK = 0x000f0000;
        static constexpr unsigned JEXTSEL(unsigned value) { return (value << 16); }
        static constexpr unsigned JEXTEN_POS = 20;
        static constexpr unsigned JEXTEN_MASK = 0x00300000;
        static constexpr unsigned JEXTEN(unsigned value) { return (value << 20); }
        static constexpr unsigned JSWSTART_POS = 22;
        static constexpr unsigned JSWSTART_MASK = 0x00400000;
        static constexpr unsigned JSWSTART(unsigned value) { return (value << 22); }
        static constexpr unsigned EXTSEL_POS = 24;
        static constexpr unsigned EXTSEL_MASK = 0x0f000000;
        static constexpr unsigned EXTSEL(unsigned value) { return (value << 24); }
        static constexpr unsigned EXTEN_POS = 28;
        static constexpr unsigned EXTEN_MASK = 0x30000000;
        static constexpr unsigned EXTEN(unsigned value) { return (value << 28); }
        static constexpr unsigned SWSTART_POS = 30;
        static constexpr unsigned SWSTART_MASK = 0x40000000;
        static constexpr unsigned SWSTART(unsigned value) { return (value << 30); }
    } CR2;
    ...
    volatile union SMPR1_T // SMPR1: sample time register 1 
    {
        ...
        {
            unsigned SMPx_x : 32; // bits 0..31 Sample time bits    
        } bit;
    
        static constexpr unsigned SMPx_x_POS = 0;
        static constexpr unsigned SMPx_x_MASK = 0xffffffff;
        static constexpr unsigned SMPx_x(unsigned value) { return (value << 0); }
    } SMPR1;
