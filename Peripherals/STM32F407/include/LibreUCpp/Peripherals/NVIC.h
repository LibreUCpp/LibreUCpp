...
{
    static constexpr size_t INSTANCE_SIZE = 848;
    static constexpr intptr_t BASE_ADDRESS = 0xe000e100;

    static constexpr intptr_t ADDR_OFFSET_ISER0 = 0x00;
    static constexpr intptr_t ADDR_OFFSET_ISER1 = 0x04;
    static constexpr intptr_t ADDR_OFFSET_ISER2 = 0x08;
    static constexpr intptr_t ADDR_OFFSET_ICER0 = 0x80;
    static constexpr intptr_t ADDR_OFFSET_ICER1 = 0x84;
    static constexpr intptr_t ADDR_OFFSET_ICER2 = 0x88;
    static constexpr intptr_t ADDR_OFFSET_ISPR0 = 0x100;
    static constexpr intptr_t ADDR_OFFSET_ISPR1 = 0x104;
    static constexpr intptr_t ADDR_OFFSET_ISPR2 = 0x108;
    static constexpr intptr_t ADDR_OFFSET_ICPR0 = 0x180;
    static constexpr intptr_t ADDR_OFFSET_ICPR1 = 0x184;
    static constexpr intptr_t ADDR_OFFSET_ICPR2 = 0x188;
    static constexpr intptr_t ADDR_OFFSET_IABR0 = 0x200;
    static constexpr intptr_t ADDR_OFFSET_IABR1 = 0x204;
    static constexpr intptr_t ADDR_OFFSET_IABR2 = 0x208;
    ...
    static constexpr intptr_t ADDR_OFFSET_IPR8 = 0x320;
    static constexpr intptr_t ADDR_OFFSET_IPR9 = 0x324;
    static constexpr intptr_t ADDR_OFFSET_IPR10 = 0x328;
    static constexpr intptr_t ADDR_OFFSET_IPR11 = 0x32c;
    static constexpr intptr_t ADDR_OFFSET_IPR12 = 0x330;
    static constexpr intptr_t ADDR_OFFSET_IPR13 = 0x334;
    static constexpr intptr_t ADDR_OFFSET_IPR14 = 0x338;
    static constexpr intptr_t ADDR_OFFSET_IPR15 = 0x33c;
    static constexpr intptr_t ADDR_OFFSET_IPR16 = 0x340;
    static constexpr intptr_t ADDR_OFFSET_IPR17 = 0x344;
    static constexpr intptr_t ADDR_OFFSET_IPR18 = 0x348;
    static constexpr intptr_t ADDR_OFFSET_IPR19 = 0x34c;
...
static_assert(sizeof(NVIC_T) == NVIC_T::INSTANCE_SIZE, "invalid peripheral register struct");
