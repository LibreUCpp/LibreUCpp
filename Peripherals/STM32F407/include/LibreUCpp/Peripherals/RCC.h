...
{
    static constexpr size_t INSTANCE_SIZE = 136;
    ...
    volatile union AHB1RSTR_T // AHB1RSTR: AHB1 peripheral reset register 
    {
        ...
        struct __attribute__((packed)) AHB1RSTR_BIT_T
        {
            ...
            unsigned GPIOIRST  : 1; // bit 8 IO port I reset
            ...
            unsigned ETHMACRST : 1; // bit 25 Ethernet MAC reset
        ...
        static constexpr unsigned GPIOIRST_POS = 8;
        static constexpr unsigned GPIOIRST_MASK = 0x00000100;
        static constexpr unsigned GPIOIRST(unsigned value) { return (value << 8); }
        ...
        static constexpr unsigned ETHMACRST_POS = 25;
        static constexpr unsigned ETHMACRST_MASK = 0x02000000;
        static constexpr unsigned ETHMACRST(unsigned value) { return (value << 25); }
    ...
    volatile union AHB2RSTR_T // AHB2RSTR: AHB2 peripheral reset register 
    {
        ...
        struct __attribute__((packed)) AHB2RSTR_BIT_T
        {
            ...
            unsigned RNGRST   : 1; // bit 6 Random number generator module reset
        ...
        static constexpr unsigned RNGRST_POS = 6;
        static constexpr unsigned RNGRST_MASK = 0x00000040;
        static constexpr unsigned RNGRST(unsigned value) { return (value << 6); }
    ...
    volatile union AHB3RSTR_T // AHB3RSTR: AHB3 peripheral reset register 
    {
        ...
        {
            unsigned FSMCRST : 1; // bit 0 Flexible static memory controller module reset
            unsigned         : 31; // bits 1..31 unused    
        } bit;
    
        static constexpr unsigned FSMCRST_POS = 0;
        static constexpr unsigned FSMCRST_MASK = 0x00000001;
        static constexpr unsigned FSMCRST(unsigned value) { return (value << 0); }
    } AHB3RSTR;
    ...
    volatile union AHB1ENR_T // AHB1ENR: AHB1 peripheral clock register 
    {
        ...
        struct __attribute__((packed)) AHB1ENR_BIT_T
        {
            ...
            unsigned GPIOIEN     : 1; // bit 8 IO port I clock enable
            unsigned             : 3; // bits 9..11 unused
            ...
            unsigned             : 2; // bits 23..24 unused
            unsigned ETHMACEN    : 1; // bit 25 Ethernet MAC clock enable
            unsigned ETHMACTXEN  : 1; // bit 26 Ethernet Transmission clock enable
            unsigned ETHMACRXEN  : 1; // bit 27 Ethernet Reception clock enable
            unsigned ETHMACPTPEN : 1; // bit 28 Ethernet PTP clock enable
        ...
        static constexpr unsigned GPIOIEN_POS = 8;
        static constexpr unsigned GPIOIEN_MASK = 0x00000100;
        static constexpr unsigned GPIOIEN(unsigned value) { return (value << 8); }
        ...
        static constexpr unsigned ETHMACEN_POS = 25;
        static constexpr unsigned ETHMACEN_MASK = 0x02000000;
        static constexpr unsigned ETHMACEN(unsigned value) { return (value << 25); }
        static constexpr unsigned ETHMACTXEN_POS = 26;
        static constexpr unsigned ETHMACTXEN_MASK = 0x04000000;
        static constexpr unsigned ETHMACTXEN(unsigned value) { return (value << 26); }
        static constexpr unsigned ETHMACRXEN_POS = 27;
        static constexpr unsigned ETHMACRXEN_MASK = 0x08000000;
        static constexpr unsigned ETHMACRXEN(unsigned value) { return (value << 27); }
        static constexpr unsigned ETHMACPTPEN_POS = 28;
        static constexpr unsigned ETHMACPTPEN_MASK = 0x10000000;
        static constexpr unsigned ETHMACPTPEN(unsigned value) { return (value << 28); }
    ...
    volatile union AHB2ENR_T // AHB2ENR: AHB2 peripheral clock enable register 
    {
        ...
        struct __attribute__((packed)) AHB2ENR_BIT_T
        {
            ...
            unsigned         : 5; // bits 1..5 unused
            unsigned RNGEN   : 1; // bit 6 Random number generator clock enable
        ...
        static constexpr unsigned RNGEN_POS = 6;
        static constexpr unsigned RNGEN_MASK = 0x00000040;
        static constexpr unsigned RNGEN(unsigned value) { return (value << 6); }
    ...
    volatile union AHB3ENR_T // AHB3ENR: AHB3 peripheral clock enable register 
    {
        ...
        {
            unsigned FSMCEN : 1; // bit 0 Flexible static memory controller module clock enable
            unsigned        : 31; // bits 1..31 unused    
        } bit;
    
        static constexpr unsigned FSMCEN_POS = 0;
        static constexpr unsigned FSMCEN_MASK = 0x00000001;
        static constexpr unsigned FSMCEN(unsigned value) { return (value << 0); }
    } AHB3ENR;
    ...
    volatile union AHB1LPENR_T // AHB1LPENR: AHB1 peripheral clock enable in low power mode register 
    {
        ...
        struct __attribute__((packed)) AHB1LPENR_BIT_T
        {
            ...
            unsigned GPIOILPEN     : 1; // bit 8 IO port I clock enable during Sleep mode
            unsigned               : 3; // bits 9..11 unused
            ...
            unsigned               : 2; // bits 23..24 unused
            unsigned ETHMACLPEN    : 1; // bit 25 Ethernet MAC clock enable during Sleep mode
            unsigned ETHMACTXLPEN  : 1; // bit 26 Ethernet transmission clock enable during Sleep mode
            unsigned ETHMACRXLPEN  : 1; // bit 27 Ethernet reception clock enable during Sleep mode
            unsigned ETHMACPTPLPEN : 1; // bit 28 Ethernet PTP clock enable during Sleep mode
        ...
        static constexpr unsigned GPIOILPEN_POS = 8;
        static constexpr unsigned GPIOILPEN_MASK = 0x00000100;
        static constexpr unsigned GPIOILPEN(unsigned value) { return (value << 8); }
        ...
        static constexpr unsigned ETHMACLPEN_POS = 25;
        static constexpr unsigned ETHMACLPEN_MASK = 0x02000000;
        static constexpr unsigned ETHMACLPEN(unsigned value) { return (value << 25); }
        static constexpr unsigned ETHMACTXLPEN_POS = 26;
        static constexpr unsigned ETHMACTXLPEN_MASK = 0x04000000;
        static constexpr unsigned ETHMACTXLPEN(unsigned value) { return (value << 26); }
        static constexpr unsigned ETHMACRXLPEN_POS = 27;
        static constexpr unsigned ETHMACRXLPEN_MASK = 0x08000000;
        static constexpr unsigned ETHMACRXLPEN(unsigned value) { return (value << 27); }
        static constexpr unsigned ETHMACPTPLPEN_POS = 28;
        static constexpr unsigned ETHMACPTPLPEN_MASK = 0x10000000;
        static constexpr unsigned ETHMACPTPLPEN(unsigned value) { return (value << 28); }
    ...
    volatile union AHB2LPENR_T // AHB2LPENR: AHB2 peripheral clock enable in low power mode register 
    {
        ...
        struct __attribute__((packed)) AHB2LPENR_BIT_T
        {
            ...
            unsigned           : 5; // bits 1..5 unused
            unsigned RNGLPEN   : 1; // bit 6 Random number generator clock enable during Sleep mode
        ...
        static constexpr unsigned RNGLPEN_POS = 6;
        static constexpr unsigned RNGLPEN_MASK = 0x00000040;
        static constexpr unsigned RNGLPEN(unsigned value) { return (value << 6); }
    ...
    volatile union AHB3LPENR_T // AHB3LPENR: AHB3 peripheral clock enable in low power mode register 
    {
        ...
        {
            unsigned FSMCLPEN : 1; // bit 0 Flexible static memory controller module clock enable during Sleep mode
            unsigned          : 31; // bits 1..31 unused    
        } bit;
    
        static constexpr unsigned FSMCLPEN_POS = 0;
        static constexpr unsigned FSMCLPEN_MASK = 0x00000001;
        static constexpr unsigned FSMCLPEN(unsigned value) { return (value << 0); }
    } AHB3LPENR;
    ...
    volatile union BDCR_T // BDCR: Backup domain control register 
    {
        ...
        struct __attribute__((packed)) BDCR_BIT_T
        {
            ...
            unsigned RTCSEL0 : 1; // bit 8 RTC clock source selection
            unsigned RTCSEL1 : 1; // bit 9 RTC clock source selection
        ...
        static constexpr unsigned RTCSEL0_POS = 8;
        static constexpr unsigned RTCSEL0_MASK = 0x00000100;
        static constexpr unsigned RTCSEL0(unsigned value) { return (value << 8); }
        static constexpr unsigned RTCSEL1_POS = 9;
        static constexpr unsigned RTCSEL1_MASK = 0x00000200;
        static constexpr unsigned RTCSEL1(unsigned value) { return (value << 9); }
    ...
    volatile union PLLI2SCFGR_T // PLLI2SCFGR: PLLI2S configuration register 
    {
        ...
        struct __attribute__((packed)) PLLI2SCFGR_BIT_T
        {
            ...
            unsigned PLLI2SNx : 9; // bits 6..14 PLLI2S multiplication factor for VCO
            unsigned          : 13; // bits 15..27 unused
            unsigned PLLI2SRx : 3; // bits 28..30 PLLI2S division factor for I2S clocks
            unsigned          : 1; // bit 31 unused    
        } bit;
    
        static constexpr unsigned PLLI2SNx_POS = 6;
        static constexpr unsigned PLLI2SNx_MASK = 0x00007fc0;
        static constexpr unsigned PLLI2SNx(unsigned value) { return (value << 6); }
        static constexpr unsigned PLLI2SRx_POS = 28;
        static constexpr unsigned PLLI2SRx_MASK = 0x70000000;
        static constexpr unsigned PLLI2SRx(unsigned value) { return (value << 28); }
    } PLLI2SCFGR;

}; // struct RCC_T

static_assert(sizeof(RCC_T) == RCC_T::INSTANCE_SIZE, "invalid peripheral register struct");
