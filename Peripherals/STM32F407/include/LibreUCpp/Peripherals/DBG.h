...
struct __attribute__((aligned(4), packed)) DBG_T
{
    ...
    volatile union DBGMCU_CR_T // DBGMCU_CR: Control Register 
    {
        ...
        struct __attribute__((packed)) DBGMCU_CR_BIT_T
        {
            ...
            unsigned DBG_TIM8_STOP          : 1; // bit 17 DBG_TIM8_STOP
        ...
        static constexpr unsigned DBG_TIM8_STOP_POS = 17;
        static constexpr unsigned DBG_TIM8_STOP_MASK = 0x00020000;
        static constexpr unsigned DBG_TIM8_STOP(unsigned value) { return (value << 17); }
...
static_assert(sizeof(DBG_T) == DBG_T::PADDED_INSTANCE_SIZE, "invalid peripheral register struct");
