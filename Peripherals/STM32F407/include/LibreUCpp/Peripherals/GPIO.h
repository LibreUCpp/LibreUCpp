...
struct __attribute__((aligned(4), packed)) GPIO_T
{
    ...
    static constexpr intptr_t BASE_ADDRESS_GPIOA = 0x40020000;
    static constexpr intptr_t BASE_ADDRESS_GPIOB = 0x40020400;
    static constexpr intptr_t BASE_ADDRESS_GPIOC = 0x40020800;
    static constexpr intptr_t BASE_ADDRESS_GPIOD = 0x40020c00;
    static constexpr intptr_t BASE_ADDRESS_GPIOE = 0x40021000;
    static constexpr intptr_t BASE_ADDRESS_GPIOF = 0x40021400;
    static constexpr intptr_t BASE_ADDRESS_GPIOG = 0x40021800;
    static constexpr intptr_t BASE_ADDRESS_GPIOH = 0x40021c00;
    static constexpr intptr_t BASE_ADDRESS_GPIOI = 0x40022000;
    static constexpr intptr_t BASE_ADDRESS_GPIOJ = 0x40022400;
    static constexpr intptr_t BASE_ADDRESS_GPIOK = 0x40022800;
