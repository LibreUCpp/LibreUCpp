...
struct __attribute__((aligned(4), packed)) SYSCFG_T
{
    ...
    volatile union MEMRM_T // MEMRM: memory remap register 
    {
        ...
        {
            unsigned MEM_MODE : 2; // bits 0..1 MEM_MODE
...
static_assert(sizeof(SYSCFG_T) == SYSCFG_T::PADDED_INSTANCE_SIZE, "invalid peripheral register struct");
