...
struct __attribute__((aligned(4), packed)) TIM3_T
{
    ...
    static constexpr intptr_t BASE_ADDRESS_TIM4 = 0x40000800;
...
static_assert(sizeof(TIM3_T) == TIM3_T::PADDED_INSTANCE_SIZE, "invalid peripheral register struct");
