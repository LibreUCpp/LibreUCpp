...
struct __attribute__((aligned(4), packed)) EXTI_T
{
    ...
    static constexpr intptr_t BASE_ADDRESS = 0x40013c00;
    ...
    volatile union IMR_T // IMR: Interrupt mask register (EXTI_IMR) 
    {
        ...
        struct __attribute__((packed)) IMR_BIT_T
        {
            ...
            unsigned MR19 : 1; // bit 19 Interrupt Mask on line 19
            unsigned MR20 : 1; // bit 20 Interrupt Mask on line 20
            unsigned MR21 : 1; // bit 21 Interrupt Mask on line 21
            unsigned MR22 : 1; // bit 22 Interrupt Mask on line 22
        ...
        static constexpr unsigned MR19_POS = 19;
        static constexpr unsigned MR19_MASK = 0x00080000;
        static constexpr unsigned MR19(unsigned value) { return (value << 19); }
        static constexpr unsigned MR20_POS = 20;
        static constexpr unsigned MR20_MASK = 0x00100000;
        static constexpr unsigned MR20(unsigned value) { return (value << 20); }
        static constexpr unsigned MR21_POS = 21;
        static constexpr unsigned MR21_MASK = 0x00200000;
        static constexpr unsigned MR21(unsigned value) { return (value << 21); }
        static constexpr unsigned MR22_POS = 22;
        static constexpr unsigned MR22_MASK = 0x00400000;
        static constexpr unsigned MR22(unsigned value) { return (value << 22); }
    } IMR;
    ...
    volatile union EMR_T // EMR: Event mask register (EXTI_EMR) 
    {
        ...
        struct __attribute__((packed)) EMR_BIT_T
        {
            ...
            unsigned MR19 : 1; // bit 19 Event Mask on line 19
            unsigned MR20 : 1; // bit 20 Event Mask on line 20
            unsigned MR21 : 1; // bit 21 Event Mask on line 21
            unsigned MR22 : 1; // bit 22 Event Mask on line 22
            unsigned      : 9; // bits 23..31 unused    
        } bit;
    ...
    volatile union RTSR_T // RTSR: Rising Trigger selection register (EXTI_RTSR) 
    {
        ...
        struct __attribute__((packed)) RTSR_BIT_T
        {
            ...
            unsigned TR19 : 1; // bit 19 Rising trigger event configuration of line 19
            unsigned TR20 : 1; // bit 20 Rising trigger event configuration of line 20
            unsigned TR21 : 1; // bit 21 Rising trigger event configuration of line 21
            unsigned TR22 : 1; // bit 22 Rising trigger event configuration of line 22
            unsigned      : 9; // bits 23..31 unused    
        } bit;
        ...
        static constexpr unsigned TR19_POS = 19;
        static constexpr unsigned TR19_MASK = 0x00080000;
        static constexpr unsigned TR19(unsigned value) { return (value << 19); }
        static constexpr unsigned TR20_POS = 20;
        static constexpr unsigned TR20_MASK = 0x00100000;
        static constexpr unsigned TR20(unsigned value) { return (value << 20); }
        static constexpr unsigned TR21_POS = 21;
        static constexpr unsigned TR21_MASK = 0x00200000;
        static constexpr unsigned TR21(unsigned value) { return (value << 21); }
        static constexpr unsigned TR22_POS = 22;
        static constexpr unsigned TR22_MASK = 0x00400000;
        static constexpr unsigned TR22(unsigned value) { return (value << 22); }
    } RTSR;
    ...
    volatile union FTSR_T // FTSR: Falling Trigger selection register (EXTI_FTSR) 
    {
        ...
        struct __attribute__((packed)) FTSR_BIT_T
        {
            ...
            unsigned TR19 : 1; // bit 19 Falling trigger event configuration of line 19
            unsigned TR20 : 1; // bit 20 Falling trigger event configuration of line 20
            unsigned TR21 : 1; // bit 21 Falling trigger event configuration of line 21
            unsigned TR22 : 1; // bit 22 Falling trigger event configuration of line 22
            unsigned      : 9; // bits 23..31 unused    
        } bit;
    ...
    volatile union SWIER_T // SWIER: Software interrupt event register (EXTI_SWIER) 
    {
        ...
        struct __attribute__((packed)) SWIER_BIT_T
        {
            ...
            unsigned SWIER19 : 1; // bit 19 Software Interrupt on line 19
            unsigned SWIER20 : 1; // bit 20 Software Interrupt on line 20
            unsigned SWIER21 : 1; // bit 21 Software Interrupt on line 21
            unsigned SWIER22 : 1; // bit 22 Software Interrupt on line 22
            unsigned         : 9; // bits 23..31 unused    
        } bit;
        ...
        static constexpr unsigned SWIER19_POS = 19;
        static constexpr unsigned SWIER19_MASK = 0x00080000;
        static constexpr unsigned SWIER19(unsigned value) { return (value << 19); }
        static constexpr unsigned SWIER20_POS = 20;
        static constexpr unsigned SWIER20_MASK = 0x00100000;
        static constexpr unsigned SWIER20(unsigned value) { return (value << 20); }
        static constexpr unsigned SWIER21_POS = 21;
        static constexpr unsigned SWIER21_MASK = 0x00200000;
        static constexpr unsigned SWIER21(unsigned value) { return (value << 21); }
        static constexpr unsigned SWIER22_POS = 22;
        static constexpr unsigned SWIER22_MASK = 0x00400000;
        static constexpr unsigned SWIER22(unsigned value) { return (value << 22); }
    } SWIER;
    ...
    volatile union PR_T // PR: Pending register (EXTI_PR) 
    {
        ...
        struct __attribute__((packed)) PR_BIT_T
        {
            ...
            unsigned PR19 : 1; // bit 19 Pending bit 19
            unsigned PR20 : 1; // bit 20 Pending bit 20
            unsigned PR21 : 1; // bit 21 Pending bit 21
            unsigned PR22 : 1; // bit 22 Pending bit 22
            unsigned      : 9; // bits 23..31 unused    
        } bit;
        ...
        static constexpr unsigned PR19_POS = 19;
        static constexpr unsigned PR19_MASK = 0x00080000;
        static constexpr unsigned PR19(unsigned value) { return (value << 19); }
        static constexpr unsigned PR20_POS = 20;
        static constexpr unsigned PR20_MASK = 0x00100000;
        static constexpr unsigned PR20(unsigned value) { return (value << 20); }
        static constexpr unsigned PR21_POS = 21;
        static constexpr unsigned PR21_MASK = 0x00200000;
        static constexpr unsigned PR21(unsigned value) { return (value << 21); }
        static constexpr unsigned PR22_POS = 22;
        static constexpr unsigned PR22_MASK = 0x00400000;
        static constexpr unsigned PR22(unsigned value) { return (value << 22); }
    } PR;

}; // struct EXTI_T

static_assert(sizeof(EXTI_T) == EXTI_T::INSTANCE_SIZE, "invalid peripheral register struct");
