...
struct __attribute__((aligned(4), packed)) NVMCTRL_T
{
    ...
    static constexpr intptr_t ADDR_OFFSET_PBLDATA0 = 0x28;
    static constexpr intptr_t ADDR_OFFSET_PBLDATA1 = 0x2c;
    ...
    volatile union CTRLB_T // CTRLB: Control B 
    {
        ...
        struct __attribute__((packed)) CTRLB_BIT_T
        {
            ...
            unsigned CACHEDIS : 2; // bits 18..19 Cache Disable
        ...
        static constexpr unsigned CACHEDIS_MASK = 0x000c0000;
    ...
    volatile union PARAM_T // PARAM: NVM Parameter 
    {
        ...
        struct __attribute__((packed)) PARAM_BIT_T
        {
            ...
            unsigned RWWEEP : 12; // bits 20..31 RWW EEPROM Pages    
        } bit;
        ...
        static constexpr unsigned RWWEEP_POS = 20;
        static constexpr unsigned RWWEEP_MASK = 0xfff00000;
        static constexpr unsigned RWWEEP(unsigned value) { return (value << 20); }
    } PARAM;
    ...
    volatile union PBLDATA0_T // PBLDATA0: Page Buffer Load Data 0 
    {
        uint32_t reg;
    } PBLDATA0;

    volatile union PBLDATA1_T // PBLDATA1: Page Buffer Load Data 1 
    {
        uint32_t reg;
    } PBLDATA1;
...
static_assert(sizeof(NVMCTRL_T) == NVMCTRL_T::INSTANCE_SIZE, "invalid peripheral register struct");
