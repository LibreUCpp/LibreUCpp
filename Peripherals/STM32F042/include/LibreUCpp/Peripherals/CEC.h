...
struct __attribute__((aligned(4), packed)) CEC_T
{
    ...
    static constexpr intptr_t BASE_ADDRESS = 0x40007800;
    ...
    volatile union CFGR_T // CFGR: configuration register 
    {
        ...
        {
            unsigned OAR     : 4; // bits 0..3 Own Address
            unsigned LSTN    : 1; // bit 4 Listen mode
            unsigned SFT     : 3; // bits 5..7 Signal Free Time
            unsigned RXTOL   : 1; // bit 8 Rx-Tolerance
            unsigned BRESTP  : 1; // bit 9 Rx-stop on bit rising error
            unsigned BREGEN  : 1; // bit 10 Generate error-bit on bit rising error
            unsigned LBPEGEN : 1; // bit 11 Generate Error-Bit on Long Bit Period Error
            unsigned         : 20; // bits 12..31 unused    
        } bit;
    
        static constexpr unsigned OAR_POS = 0;
        static constexpr unsigned OAR_MASK = 0x0000000f;
        static constexpr unsigned OAR(unsigned value) { return (value << 0); }
        static constexpr unsigned LSTN_POS = 4;
        static constexpr unsigned LSTN_MASK = 0x00000010;
        static constexpr unsigned LSTN(unsigned value) { return (value << 4); }
        static constexpr unsigned SFT_POS = 5;
        static constexpr unsigned SFT_MASK = 0x000000e0;
        static constexpr unsigned SFT(unsigned value) { return (value << 5); }
        static constexpr unsigned RXTOL_POS = 8;
        static constexpr unsigned RXTOL_MASK = 0x00000100;
        static constexpr unsigned RXTOL(unsigned value) { return (value << 8); }
        static constexpr unsigned BRESTP_POS = 9;
        static constexpr unsigned BRESTP_MASK = 0x00000200;
        static constexpr unsigned BRESTP(unsigned value) { return (value << 9); }
        static constexpr unsigned BREGEN_POS = 10;
        static constexpr unsigned BREGEN_MASK = 0x00000400;
        static constexpr unsigned BREGEN(unsigned value) { return (value << 10); }
        static constexpr unsigned LBPEGEN_POS = 11;
        static constexpr unsigned LBPEGEN_MASK = 0x00000800;
        static constexpr unsigned LBPEGEN(unsigned value) { return (value << 11); }
    } CFGR;
...
static_assert(sizeof(CEC_T) == CEC_T::PADDED_INSTANCE_SIZE, "invalid peripheral register struct");
