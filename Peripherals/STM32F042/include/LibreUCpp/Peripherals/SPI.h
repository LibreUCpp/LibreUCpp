...
struct __attribute__((aligned(4), packed)) SPI_T
{
    ...
    volatile union CR2_T // CR2: control register 2 
    {
        ...
        struct __attribute__((packed)) CR2_BIT_T
        {
            ...
            unsigned NSSP    : 1; // bit 3 NSS pulse management
            ...
            unsigned DS      : 4; // bits 8..11 Data size
            unsigned FRXTH   : 1; // bit 12 FIFO reception threshold
            unsigned LDMA_RX : 1; // bit 13 Last DMA transfer for reception
            unsigned LDMA_TX : 1; // bit 14 Last DMA transfer for transmission
        ...
        static constexpr unsigned NSSP_POS = 3;
        static constexpr unsigned NSSP_MASK = 0x00000008;
        static constexpr unsigned NSSP(unsigned value) { return (value << 3); }
        ...
        static constexpr unsigned DS_POS = 8;
        static constexpr unsigned DS_MASK = 0x00000f00;
        static constexpr unsigned DS(unsigned value) { return (value << 8); }
        static constexpr unsigned FRXTH_POS = 12;
        static constexpr unsigned FRXTH_MASK = 0x00001000;
        static constexpr unsigned FRXTH(unsigned value) { return (value << 12); }
        static constexpr unsigned LDMA_RX_POS = 13;
        static constexpr unsigned LDMA_RX_MASK = 0x00002000;
        static constexpr unsigned LDMA_RX(unsigned value) { return (value << 13); }
        static constexpr unsigned LDMA_TX_POS = 14;
        static constexpr unsigned LDMA_TX_MASK = 0x00004000;
        static constexpr unsigned LDMA_TX(unsigned value) { return (value << 14); }
    } CR2;
    ...
    volatile union SR_T // SR: status register 
    {
        ...
        struct __attribute__((packed)) SR_BIT_T
        {
            ...
            unsigned FRLVL  : 2; // bits 9..10 FIFO reception level
            unsigned FTLVL  : 2; // bits 11..12 FIFO transmission level
        ...
        static constexpr unsigned FRLVL_POS = 9;
        static constexpr unsigned FRLVL_MASK = 0x00000600;
        static constexpr unsigned FRLVL(unsigned value) { return (value << 9); }
        static constexpr unsigned FTLVL_POS = 11;
        static constexpr unsigned FTLVL_MASK = 0x00001800;
        static constexpr unsigned FTLVL(unsigned value) { return (value << 11); }
    } SR;
...
static_assert(sizeof(SPI_T) == SPI_T::PADDED_INSTANCE_SIZE, "invalid peripheral register struct");
