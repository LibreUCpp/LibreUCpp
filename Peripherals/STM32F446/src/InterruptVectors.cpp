...
extern "C" {
    ...
    void UART8_Handler() __attribute__ ((weak, alias("Default_Handler")));
...
const pFunc InterruptVectorTable[106] __attribute__((used, section(".vectors"))) {
    ...
    0, // int 80: reserved
    0, // int 81: reserved
    UART7_Handler, // int 82: UART7
    UART8_Handler, // int 83: UART8
    SPI4_Handler, // int 84: SPI4
    0, // int 85: reserved
    0, // int 86: reserved
    0, // int 87: reserved
