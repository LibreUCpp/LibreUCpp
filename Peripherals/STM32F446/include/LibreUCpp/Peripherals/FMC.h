...
struct __attribute__((aligned(4), packed)) FMC_T
{
    static constexpr size_t INSTANCE_SIZE = 348;
    static constexpr size_t PADDED_INSTANCE_SIZE = 348;
    ...
    static constexpr intptr_t ADDR_OFFSET_SDCR1 = 0x140;
    static constexpr intptr_t ADDR_OFFSET_SDCR2 = 0x144;
    static constexpr intptr_t ADDR_OFFSET_SDTR1 = 0x148;
    static constexpr intptr_t ADDR_OFFSET_SDTR2 = 0x14c;
    static constexpr intptr_t ADDR_OFFSET_SDCMR = 0x150;
    static constexpr intptr_t ADDR_OFFSET_SDRTR = 0x154;
    static constexpr intptr_t ADDR_OFFSET_SDSR = 0x158;
    ...
    volatile union BCR1_T // BCR1: SRAM/NOR-Flash chip-select control register 1 
    {
        ...
        struct __attribute__((packed)) BCR1_BIT_T
        {
            ...
            unsigned CCLKEN    : 1; // bit 20 CCLKEN
        ...
        static constexpr unsigned CCLKEN_POS = 20;
        static constexpr unsigned CCLKEN_MASK = 0x00100000;
        static constexpr unsigned CCLKEN(unsigned value) { return (value << 20); }
    } BCR1;
    ...
    volatile union SDCR1_T // SDCR1: SDRAM Control Register 1 
    {
        uint32_t reg;
        struct __attribute__((packed)) SDCR1_BIT_T
        {
            unsigned NC     : 2; // bits 0..1 Number of column address bits
            unsigned NR     : 2; // bits 2..3 Number of row address bits
            unsigned MWID   : 2; // bits 4..5 Memory data bus width
            unsigned NB     : 1; // bit 6 Number of internal banks
            unsigned CAS    : 2; // bits 7..8 CAS latency
            unsigned WP     : 1; // bit 9 Write protection
            unsigned SDCLK  : 2; // bits 10..11 SDRAM clock configuration
            unsigned RBURST : 1; // bit 12 Burst read
            unsigned RPIPE  : 2; // bits 13..14 Read pipe
            unsigned        : 17; // bits 15..31 unused    
        } bit;
    
        static constexpr unsigned NC_POS = 0;
        static constexpr unsigned NC_MASK = 0x00000003;
        static constexpr unsigned NC(unsigned value) { return (value << 0); }
        static constexpr unsigned NR_POS = 2;
        static constexpr unsigned NR_MASK = 0x0000000c;
        static constexpr unsigned NR(unsigned value) { return (value << 2); }
        static constexpr unsigned MWID_POS = 4;
        static constexpr unsigned MWID_MASK = 0x00000030;
        static constexpr unsigned MWID(unsigned value) { return (value << 4); }
        static constexpr unsigned NB_POS = 6;
        static constexpr unsigned NB_MASK = 0x00000040;
        static constexpr unsigned NB(unsigned value) { return (value << 6); }
        static constexpr unsigned CAS_POS = 7;
        static constexpr unsigned CAS_MASK = 0x00000180;
        static constexpr unsigned CAS(unsigned value) { return (value << 7); }
        static constexpr unsigned WP_POS = 9;
        static constexpr unsigned WP_MASK = 0x00000200;
        static constexpr unsigned WP(unsigned value) { return (value << 9); }
        static constexpr unsigned SDCLK_POS = 10;
        static constexpr unsigned SDCLK_MASK = 0x00000c00;
        static constexpr unsigned SDCLK(unsigned value) { return (value << 10); }
        static constexpr unsigned RBURST_POS = 12;
        static constexpr unsigned RBURST_MASK = 0x00001000;
        static constexpr unsigned RBURST(unsigned value) { return (value << 12); }
        static constexpr unsigned RPIPE_POS = 13;
        static constexpr unsigned RPIPE_MASK = 0x00006000;
        static constexpr unsigned RPIPE(unsigned value) { return (value << 13); }
    } SDCR1;

    volatile union SDCR2_T // SDCR2: SDRAM Control Register 2 
    {
        uint32_t reg;
        struct __attribute__((packed)) SDCR2_BIT_T
        {
            unsigned NC     : 2; // bits 0..1 Number of column address bits
            unsigned NR     : 2; // bits 2..3 Number of row address bits
            unsigned MWID   : 2; // bits 4..5 Memory data bus width
    ...
    volatile union SDTR1_T // SDTR1: SDRAM Timing register 1 
    {
        uint32_t reg;
        struct __attribute__((packed)) SDTR1_BIT_T
        {
            unsigned TMRD : 4; // bits 0..3 Load Mode Register to Active
            unsigned TXSR : 4; // bits 4..7 Exit self-refresh delay
            unsigned TRAS : 4; // bits 8..11 Self refresh time
            unsigned TRC  : 4; // bits 12..15 Row cycle delay
            unsigned TWR  : 4; // bits 16..19 Recovery delay
            unsigned TRP  : 4; // bits 20..23 Row precharge delay
            unsigned TRCD : 4; // bits 24..27 Row to column delay
            unsigned      : 4; // bits 28..31 unused    
        } bit;
    
        static constexpr unsigned TMRD_POS = 0;
        static constexpr unsigned TMRD_MASK = 0x0000000f;
        static constexpr unsigned TMRD(unsigned value) { return (value << 0); }
        static constexpr unsigned TXSR_POS = 4;
        static constexpr unsigned TXSR_MASK = 0x000000f0;
        static constexpr unsigned TXSR(unsigned value) { return (value << 4); }
        static constexpr unsigned TRAS_POS = 8;
        static constexpr unsigned TRAS_MASK = 0x00000f00;
        static constexpr unsigned TRAS(unsigned value) { return (value << 8); }
        static constexpr unsigned TRC_POS = 12;
        static constexpr unsigned TRC_MASK = 0x0000f000;
        static constexpr unsigned TRC(unsigned value) { return (value << 12); }
        static constexpr unsigned TWR_POS = 16;
        static constexpr unsigned TWR_MASK = 0x000f0000;
        static constexpr unsigned TWR(unsigned value) { return (value << 16); }
        static constexpr unsigned TRP_POS = 20;
        static constexpr unsigned TRP_MASK = 0x00f00000;
        static constexpr unsigned TRP(unsigned value) { return (value << 20); }
        static constexpr unsigned TRCD_POS = 24;
        static constexpr unsigned TRCD_MASK = 0x0f000000;
        static constexpr unsigned TRCD(unsigned value) { return (value << 24); }
    } SDTR1;

    volatile union SDTR2_T // SDTR2: SDRAM Timing register 2 
    {
        uint32_t reg;
        struct __attribute__((packed)) SDTR2_BIT_T
        {
            unsigned TMRD : 4; // bits 0..3 Load Mode Register to Active
            unsigned TXSR : 4; // bits 4..7 Exit self-refresh delay
            unsigned TRAS : 4; // bits 8..11 Self refresh time
    ...
    volatile union SDCMR_T // SDCMR: SDRAM Command Mode register 
    {
        uint32_t reg;
        struct __attribute__((packed)) SDCMR_BIT_T
        {
            unsigned MODE : 3; // bits 0..2 Command mode
            unsigned CTB2 : 1; // bit 3 Command target bank 2
            unsigned CTB1 : 1; // bit 4 Command target bank 1
            unsigned NRFS : 4; // bits 5..8 Number of Auto-refresh
            unsigned MRD  : 13; // bits 9..21 Mode Register definition
            unsigned      : 10; // bits 22..31 unused    
        } bit;
    
        static constexpr unsigned MODE_POS = 0;
        static constexpr unsigned MODE_MASK = 0x00000007;
        static constexpr unsigned MODE(unsigned value) { return (value << 0); }
        static constexpr unsigned CTB2_POS = 3;
        static constexpr unsigned CTB2_MASK = 0x00000008;
        static constexpr unsigned CTB2(unsigned value) { return (value << 3); }
        static constexpr unsigned CTB1_POS = 4;
        static constexpr unsigned CTB1_MASK = 0x00000010;
        static constexpr unsigned CTB1(unsigned value) { return (value << 4); }
        static constexpr unsigned NRFS_POS = 5;
        static constexpr unsigned NRFS_MASK = 0x000001e0;
        static constexpr unsigned NRFS(unsigned value) { return (value << 5); }
        static constexpr unsigned MRD_POS = 9;
        static constexpr unsigned MRD_MASK = 0x003ffe00;
        static constexpr unsigned MRD(unsigned value) { return (value << 9); }
    } SDCMR;

    volatile union SDRTR_T // SDRTR: SDRAM Refresh Timer register 
    {
        uint32_t reg;
        struct __attribute__((packed)) SDRTR_BIT_T
        {
            unsigned CRE   : 1; // bit 0 Clear Refresh error flag
            unsigned COUNT : 13; // bits 1..13 Refresh Timer Count
            unsigned REIE  : 1; // bit 14 RES Interrupt Enable
            unsigned       : 17; // bits 15..31 unused    
        } bit;
    
        static constexpr unsigned CRE_POS = 0;
        static constexpr unsigned CRE_MASK = 0x00000001;
        static constexpr unsigned CRE(unsigned value) { return (value << 0); }
        static constexpr unsigned COUNT_POS = 1;
        static constexpr unsigned COUNT_MASK = 0x00003ffe;
        static constexpr unsigned COUNT(unsigned value) { return (value << 1); }
        static constexpr unsigned REIE_POS = 14;
        static constexpr unsigned REIE_MASK = 0x00004000;
        static constexpr unsigned REIE(unsigned value) { return (value << 14); }
    } SDRTR;

    volatile union SDSR_T // SDSR: SDRAM Status register 
    {
        uint32_t reg;
        struct __attribute__((packed)) SDSR_BIT_T
        {
            unsigned RE     : 1; // bit 0 Refresh error flag
            unsigned MODES1 : 2; // bits 1..2 Status Mode for Bank 1
            unsigned MODES2 : 2; // bits 3..4 Status Mode for Bank 2
            unsigned BUSY   : 1; // bit 5 Busy status
            unsigned        : 26; // bits 6..31 unused    
        } bit;
    
        static constexpr unsigned RE_POS = 0;
        static constexpr unsigned RE_MASK = 0x00000001;
        static constexpr unsigned RE(unsigned value) { return (value << 0); }
        static constexpr unsigned MODES1_POS = 1;
        static constexpr unsigned MODES1_MASK = 0x00000006;
        static constexpr unsigned MODES1(unsigned value) { return (value << 1); }
        static constexpr unsigned MODES2_POS = 3;
        static constexpr unsigned MODES2_MASK = 0x00000018;
        static constexpr unsigned MODES2(unsigned value) { return (value << 3); }
...
static_assert(sizeof(FMC_T) == FMC_T::PADDED_INSTANCE_SIZE, "invalid peripheral register struct");
