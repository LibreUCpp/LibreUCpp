...
struct __attribute__((aligned(4), packed)) DAC_T
{
    ...
    volatile union CR_T // CR: control register 
    {
        ...
        struct __attribute__((packed)) CR_BIT_T
        {
            ...
            unsigned DMAUDRIE2 : 1; // bit 29 DAC channel2 DMA underrun interrupt enable
        ...
        static constexpr unsigned DMAUDRIE2_POS = 29;
        static constexpr unsigned DMAUDRIE2_MASK = 0x20000000;
        static constexpr unsigned DMAUDRIE2(unsigned value) { return (value << 29); }
    } CR;
    ...
    volatile union DHR12R2_T // DHR12R2: channel2 12-bit right aligned data holding register 
    {
        uint32_t reg;
    ...
    volatile union DHR12L2_T // DHR12L2: channel2 12-bit left aligned data holding register 
    {
        uint32_t reg;
    ...
    volatile union DHR8R2_T // DHR8R2: channel2 8-bit right-aligned data holding register 
    {
        uint32_t reg;
    ...
    volatile union DHR12RD_T // DHR12RD: Dual DAC 12-bit right-aligned data holding register 
    {
        uint32_t reg;
    ...
    volatile union DHR12LD_T // DHR12LD: DUAL DAC 12-bit left aligned data holding register 
    {
        uint32_t reg;
        struct __attribute__((packed)) DHR12LD_BIT_T
        {
            ...
            unsigned DACC2DHR : 12; // bits 20..31 DAC channel2 12-bit left-aligned data    
        } bit;
    ...
    volatile union DHR8RD_T // DHR8RD: DUAL DAC 8-bit right aligned data holding register 
    {
        uint32_t reg;
    ...
    volatile union DOR2_T // DOR2: channel2 data output register 
    {
        uint32_t reg;
