...
struct __attribute__((aligned(4), packed)) OTG_FS_GLOBAL_T
{
    ...
    volatile union FS_GUSBCFG_T // FS_GUSBCFG: OTG_FS USB configuration register (OTG_FS_GUSBCFG) 
    {
        ...
        struct __attribute__((packed)) FS_GUSBCFG_BIT_T
        {
            ...
            unsigned PHYSEL : 1; // bit 6 Full Speed serial transceiver select
...
static_assert(sizeof(OTG_FS_GLOBAL_T) == OTG_FS_GLOBAL_T::PADDED_INSTANCE_SIZE, "invalid peripheral register struct");
