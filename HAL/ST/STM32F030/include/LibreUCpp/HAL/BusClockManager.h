...
class BusClockManager
{
    public:
        ...
        enum class Peripheral : unsigned
        {
            ...
            IOPA   = PREFIX_AHB + RCC_T::AHBENR_T::IOPAEN_POS,
            IOPB   = PREFIX_AHB + RCC_T::AHBENR_T::IOPBEN_POS,
            IOPC   = PREFIX_AHB + RCC_T::AHBENR_T::IOPCEN_POS,
            IOPD   = PREFIX_AHB + RCC_T::AHBENR_T::IOPDEN_POS,
            IOPF   = PREFIX_AHB + RCC_T::AHBENR_T::IOPFEN_POS,
